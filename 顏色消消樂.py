...
# Define fonts
font_medium = pygame.font.Font(None, 64)  # Increase font size for buttons
...
rules_pos = (408, 408)  # Position for "規則說明"
easy_pos = (650, 580)   # Position for "易"
medium_pos = (650, 640) # Position for "中"
hard_pos = (650, 740)   # Position for "難"
title_pos = (400, 400)
...
easy_surface = font_medium.render(easy_text, True, BLACK)
medium_surface = font_medium.render(medium_text, True, BLACK)
hard_surface = font_medium.render(hard_text, True, BLACK)
rules_surface = font_medium.render(rules_text, True, BLACK)
